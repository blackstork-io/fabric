...
func file_pluginapi_v1_dataspec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pluginapi_v1_dataspec_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_pluginapi_v1_dataspec_proto_msgTypes[0].OneofWrappers = []any{
		(*Spec_Attr)(nil),
		(*Spec_Block)(nil),
		(*Spec_ObjSpec)(nil),
		(*Spec_ObjDump)(nil),
	...
	file_pluginapi_v1_dataspec_proto_msgTypes[7].OneofWrappers = []any{
