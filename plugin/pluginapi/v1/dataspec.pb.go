...
type AttrSpec struct {
	...
	Depricated   string      `protobuf:"bytes,11,opt,name=depricated,proto3" json:"depricated,omitempty"`
}
...
func (x *AttrSpec) GetDepricated() string {
	if x != nil {
		return x.Depricated
	}
	return ""
...
var file_pluginapi_v1_dataspec_proto_rawDesc = []byte{
	...
	0x0a, 0x64, 0x65, 0x70, 0x72, 0x69, 0x63, 0x61, 0x74, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x64, 0x65, 0x70, 0x72, 0x69, 0x63, 0x61, 0x74, 0x65, 0x64, 0x22, 0x79, 0x0a,
