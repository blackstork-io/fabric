...
type Block struct {
	...
	Attributes    map[string]*Attr `protobuf:"bytes,3,rep,name=attributes,proto3" json:"attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *BlockSpec_NameMatcher) GetMatcher() isBlockSpec_NameMatcher_Matcher {
	if m != nil {
		return m.Matcher
	}
	return nil
...
func (x *BlockSpec_NameMatcher) GetExact() *BlockSpec_NameMatcher_Exact {
	if x, ok := x.GetMatcher().(*BlockSpec_NameMatcher_Exact_); ok {
		return x.Exact
	}
	return nil
}
...
func file_pluginapi_v1_dataspec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*BlockSpec_NameMatcher); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pluginapi_v1_dataspec_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*BlockSpec_NameMatcher_Exact); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
