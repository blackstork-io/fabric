...
func file_pluginapi_v1_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pluginapi_v1_content_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pluginapi_v1_content_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContentSection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pluginapi_v1_content_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContentElement); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pluginapi_v1_content_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContentEmpty); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pluginapi_v1_content_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*Content_Element)(nil),
		(*Content_Section)(nil),
		(*Content_Empty)(nil),
	}
