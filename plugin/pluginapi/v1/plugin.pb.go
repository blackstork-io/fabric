...
type RenderNodeResponse struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	SubtreeReplacement []*v1.Node             `protobuf:"bytes,1,rep,name=subtree_replacement,json=subtreeReplacement,proto3" json:"subtree_replacement,omitempty"`
	Diagnostics        []*Diagnostic          `protobuf:"bytes,2,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
var file_pluginapi_v1_plugin_proto_rawDesc = string([]byte{
	...
	0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x6f, 0x64,
