...
const file_pluginapi_v1_cty_proto_rawDesc = "" +
	...
	"\bCtyValue\x12'\n" +
	"\x05value\x18\x01 \x01(\v2\x11.pluginapi.v1.CtyR\x05valueB\xae\x01\n" +
	"\x10com.pluginapi.v1B\bCtyProtoP\x01Z?github.com/blackstork-io/fabric/plugin/pluginapi/v1;pluginapiv1\xa2\x02\x03PXX\xaa\x02\fPluginapi.V1\xca\x02\fPluginapi\\V1\xe2\x02\x18Pluginapi\\V1\\GPBMetadata\xea\x02\rPluginapi::V1b\x06proto3"
