...
type Schema struct {
	...
	Publishers       map[string]*PublisherSchema       `protobuf:"bytes,5,rep,name=publishers,proto3" json:"publishers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Doc              string                            `protobuf:"bytes,6,opt,name=doc,proto3" json:"doc,omitempty"`
	Tags             []string                          `protobuf:"bytes,7,rep,name=tags,proto3" json:"tags,omitempty"`
	// List of node type names that can be rendered by the plugin.
	// All custom nodes that are emitted by the content provider must be in this list.
	NodeRenderers []string `protobuf:"bytes,8,rep,name=node_renderers,json=nodeRenderers,proto3" json:"node_renderers,omitempty"`
...
func (x *Schema) GetNodeRenderers() []string {
	if x != nil {
		return x.NodeRenderers
	}
	return nil
}
...
var file_pluginapi_v1_schema_proto_rawDesc = string([]byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x94, 0x05, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x61,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x6f, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61,
	0x67, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x25,
	0x0a, 0x0e, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x72, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x65, 0x72, 0x73,
	0x18, 0x08, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x6e, 0x64,
	0x65, 0x72, 0x65, 0x72, 0x73, 0x1a, 0x5e, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x68, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	...
	,
	...
	0x6f, 0x63, 0x6b, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x12, 0x2f, 0x0a,
	...
	0x63, 0x6b, 0x53, 0x70, 0x65, 0x63, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x10,
	...
	,
...
var file_pluginapi_v1_schema_proto_goTypes = []any{
	...
	nil,                           // 6: pluginapi.v1.Schema.PublishersEntry
	(*BlockSpec)(nil),             // 7: pluginapi.v1.BlockSpec
}
var file_pluginapi_v1_schema_proto_depIdxs = []int32{
	...
	6,  // 2: pluginapi.v1.Schema.publishers:type_name -> pluginapi.v1.Schema.PublishersEntry
	7,  // 3: pluginapi.v1.DataSourceSchema.args:type_name -> pluginapi.v1.BlockSpec
	7,  // 4: pluginapi.v1.DataSourceSchema.config:type_name -> pluginapi.v1.BlockSpec
	7,  // 5: pluginapi.v1.ContentProviderSchema.args:type_name -> pluginapi.v1.BlockSpec
	7,  // 6: pluginapi.v1.ContentProviderSchema.config:type_name -> pluginapi.v1.BlockSpec
	7,  // 7: pluginapi.v1.PublisherSchema.args:type_name -> pluginapi.v1.BlockSpec
	7,  // 8: pluginapi.v1.PublisherSchema.config:type_name -> pluginapi.v1.BlockSpec
	1,  // 9: pluginapi.v1.Schema.DataSourcesEntry.value:type_name -> pluginapi.v1.DataSourceSchema
	2,  // 10: pluginapi.v1.Schema.ContentProvidersEntry.value:type_name -> pluginapi.v1.ContentProviderSchema
	3,  // 11: pluginapi.v1.Schema.PublishersEntry.value:type_name -> pluginapi.v1.PublisherSchema
