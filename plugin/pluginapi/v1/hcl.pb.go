...
func file_pluginapi_v1_hcl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pluginapi_v1_hcl_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pos); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pluginapi_v1_hcl_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pluginapi_v1_hcl_proto_msgTypes[2].Exporter = func(v any, i int) any {
