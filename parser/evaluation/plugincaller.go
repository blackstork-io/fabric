...
type ContentCaller interface {
	CallContent(ctx context.Context, name string, config Configuration, invocation Invocation, context plugin.MapData) (result *plugin.Content, diag diagnostics.Diag)
